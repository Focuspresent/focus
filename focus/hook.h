#ifndef __FOCUS_HOOK_H__
#define __FOCUS_HOOK_H__
...
typedef ssize_t (*recvfrom_fun)(int sockfd, void* buf, size_t len, int flags, struct sockaddr* srcaddr, socklen_t* addrlen);
